...
class OrderViewModel : ViewModel() {
    ...
    private val _formattedPrice = MediatorLiveData<String>().apply {
        addSource(_price) { value = NumberFormat.getCurrencyInstance().format(it) }
    }
    val price: LiveData<String> = _formattedPrice
